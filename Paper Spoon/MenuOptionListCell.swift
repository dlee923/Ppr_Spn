...
class MenuOptionListCell: UICollectionViewCell {
    ...
    private func addViewThumbnail() {
        ...
        self.thumbnailView.widthAnchor.constraint(equalTo: self.widthAnchor, constant: 0).isActive = true
    ...
    private func addViewTitle() {
        ...
        self.titleView.topAnchor.constraint(equalTo: self.topAnchor, constant: 0).isActive = true
